...
class BobTest < MiniTest::Unit::TestCase
  def test_stating_something
    assert_equal 'Whatever.', ::Bob.new.hey('Tom-ay-to, tom-aaaah-to.') #when we tell bob tomayto tomato, he says whatever
  end
  ...
  def test_shouting_gibberish  #there was no failure here - not meant to be one.
  ...
  def test_asking_a_numeric_question #there was no failure - red herring. Doesn't matter if numeric.
